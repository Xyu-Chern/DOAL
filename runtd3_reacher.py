...
wandb.init(
    ...
    config={"algo": "TD3", "env": "brax/reacher"}
)
...
algo = WandBTD3.create(
    ...
    # 优化器参数
    learning_rate=0.000217684386462317,  # ~2.177e-4
    ...
    # RL核心参数
    gamma=0.995,  # 较高的折扣因子
    polyak=0.98,  # 目标网络更新系数
    
    # 训练稳定性（Swimmer需要很小的梯度裁剪）
    max_grad_norm=0.1,  # 非常小的梯度裁剪阈值
