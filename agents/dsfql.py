...
class DSFQLAgent(DOALAgent):
    ...
    def actor_loss(self, batch, grad_params, rng):
        ...
        doal_distill_loss = self.doal_one_step_loss(batch, grad_params, rng, schedule_type="gradient")
    ...
    def doal_one_step_loss(self, batch, grad_params, rng, schedule_type="gradient"):
    ...
    def sample_actions(
        ...
        actions = self.network.select('actor_onestep_doal_flow')(observations, noises)
        actions = jnp.clip(actions, -1, 1)
        return actions
    ...
    def create(
        ...
        actor_doal_onestep_flow_def = ActorVectorField(
            hidden_dims=config['actor_hidden_dims'],
            action_dim=action_dim,
            layer_norm=config['actor_layer_norm'],
        ...
        network_info = dict(
           ...
           actor_onestep_doal_flow = (actor_doal_onestep_flow_def, (ex_observations, ex_actions))
        )
