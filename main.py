...
flags.DEFINE_integer('offline_steps', 1500000, 'Number of offline steps.')
...
flags.DEFINE_boolean('clip',None, 'coffeient for conservative') 
...
flags.DEFINE_boolean('normalize_q_loss', None , 'coffeient for conservative')
flags.DEFINE_string('loss_type', None,  'coffeient for conservative')
