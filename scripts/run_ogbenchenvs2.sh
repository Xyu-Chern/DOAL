...
env_names=('antmaze-giant-navigate-singletask-v0' 'humanoidmaze-large-navigate-singletask-v0'  "cube-double-play-singletask-task2-v0"  "puzzle-3x3-play-singletask-task4-v0" "puzzle-4x4-play-singletask-task4-v0")
